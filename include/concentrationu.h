...
namespace Comp5201Project
{
    ...
    class ConcentrationU : public QWidget
    {
        Q_OBJECT
        ...
        public:
            ...
            ConcentrationU(QWidget* parent = 0);
            virtual ~ConcentrationU();
        ...
        protected:
            ...
            QWidget* m_settings;
            Ui::concentrationu* m_ui_concentration;
    };
}

#endif //!defined(COMP_5201_PROJECT_CONCENTRATIONU_H)
