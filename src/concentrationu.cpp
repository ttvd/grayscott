...
namespace Comp5201Project
{
	...
	//--
	ConcentrationU::ConcentrationU(QWidget* parent) :
	QWidget(parent),
	...
	//--
	void
	ConcentrationU::mousePressEvent(QMouseEvent* event)
	{
	...
	//--
	void
	ConcentrationU::mouseMoveEvent(QMouseEvent* event)
	{
	...
	//--
	void 
	ConcentrationU::mouseReleaseEvent(QMouseEvent* event)
 	{
    ...
    //--
    void 
    ConcentrationU::paintEvent(QPaintEvent* event)
 	{
	...
	//--
	void 
	ConcentrationU::drawLineTo(const QPoint& end_point)
	{
	...
	//--
	void 
	ConcentrationU::resizeEvent(QResizeEvent* event)
	{
	...
	//--
	void 
	ConcentrationU::resizeImage(QImage* image, const QSize& new_size)
	{
	...
	//--
	void
	ConcentrationU::clearConcentration()
	{
	...
	//--
	void 
	ConcentrationU::createSettings()
	{
		m_settings = new QWidget();
		m_ui_concentration = new Ui::concentrationu();
	...
	//--
	void 
	ConcentrationU::requestDock(Window* window, QDockWidget* dock)
	{
        Q_UNUSED(window);
	...
	//--
	void 
	ConcentrationU::sliderEventSize(int size)
	{
		m_pen_width = size;
	...
	//--
    void
    ConcentrationU::sliderEventConcentration(int c)
    {
    	m_concentration = c;
    ...
    //--
    void
    ConcentrationU::sliderEventBaseConcentration(int c)
    {
     		...
     		int pos_x = rand() % m_image.width();
       		...
       		for(int side_x = 0; side_x < side; ++side_x)
       		{
       			...
       			for(int side_y = 0; side_y < side; ++side_y)
       			{
                    ...
                    buffer[side_x + pos_x][side_y + pos_y] = conc_u;
       			}
       		}
     	}
    ...
    //--
    void 
    ConcentrationU::concentration(QImage& img)
    {
    	img = m_image;
    }
}
